    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        { @Override
            ...
            if(TextUtils.isEmpty(nama)) {
                editNama.setError("Isilah Nama Anda Dengan Benar!");
                return;
            }
            else if(TextUtils.isEmpty(tahun)) {
                editTahun.setError("Isilah Tahun Kelahiran Anda Dengan Benar!");
                return;
            }
            else if(TextUtils.isEmpty(alamat)) {
                editAlamat.setError("Isilah Alamat Anda Dengan Benar!");
                return;
            }
            else if(TextUtils.isEmpty(telepon)) {
                editTelepon.setError("Isilah Nomor Telepon Anda Dengan Benar!");
                return;
            }
            else if(TextUtils.isEmpty(email)) {
                editEmail.setError("Isilah ALamat Email Anda Dengan Benar!");
                return;
            }
            Intent i = null;
