...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTahun.setText("Anda lahir pada tahun " +get_tahun);
        txtAlamat.setText("Alamat tinggal Anda di " +get_alamat);
        txtTelepon.setText("Nomor telepon Anda " +get_telepon);
        txtEmail.setText("Alamat E-mail Anda adalah " +get_email);
    }
}
